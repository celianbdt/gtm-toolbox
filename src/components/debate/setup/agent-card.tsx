    ...
    >
      {onRemove && (
        <button
          ...
          className="absolute top-2 right-2 w-5 h-5 rounded-full bg-zinc-700 hover:bg-zinc-600 text-foreground text-xs flex items-center justify-center transition-colors"
        >
          ×
        </button>
      )}
