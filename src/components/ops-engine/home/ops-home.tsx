  ...
  return (
    <div className="flex flex-col gap-8 p-6 overflow-y-auto flex-1">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <StatCard
          icon={<Table2 className="size-4 text-violet-400" />}
          label="Tables"
          value={loading ? null : totalTables}
        />
        <StatCard
          icon={<Rows3 className="size-4 text-violet-400" />}
          label="Total rows"
        ...
        <button
          ...
          className="text-left transition-colors hover:ring-violet-500/40 hover:ring-2 rounded-xl"
        >
          <StatCard
